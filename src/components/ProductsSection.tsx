          ...
          {displayedProducts.map((product, index) => (
            ...
            >
              <motion.div
                ...
                className="pointer-events-none absolute -inset-0.5 z-0 bg-gradient-to-br from-primary/20 via-emerald-400/20 to-primary/20 rounded-3xl blur-sm md:blur"
              />
              <Card className="relative z-10 h-full overflow-hidden rounded-3xl border border-white/20 bg-white/70 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col group/card">
                {/* Efecto de brillo en hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover/card:translate-x-full transition-transform duration-1000 ease-in-out z-20 pointer-events-none" />
